...
interface GroupedContent {
  ...
  LAB_ASSIGNMENT: ContentItem[]
  QUESTION_PAPER: ContentItem[]
  LAB_MANUAL: ContentItem[]
  REFERENCE_MATERIAL: ContentItem[]
}

interface FacultyCourseContentClientProps {
  facultyId: string
  courseCode: string
}

export default function FacultyCourseContentClient({ facultyId, courseCode }: FacultyCourseContentClientProps) {
